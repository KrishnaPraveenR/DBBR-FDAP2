...
const uint16 g_aunCCITTCrcTable[256]={
...
// Parameters: p_pucBuf - const unsigned char * - the buffer to be CRCd
//             p_ucLen   - unsigned char - the length of the input buffer
// Return: the computed CRC
/////////////////////////////////////////////////////////////////////////////////// 
uint16 ComputeCCITTCRC(const uint8 *p_pucBuf, uint8 p_ucLen)
{
    uint16 unAcumulator = 0xFFFF;
    	
    for ( ; p_ucLen ; p_ucLen-- )
    {	
      	unAcumulator = COMPUTE_CRC(unAcumulator,*p_pucBuf);
      	p_pucBuf++;
    }
    return unAcumulator;
}
