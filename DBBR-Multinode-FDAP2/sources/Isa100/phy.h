...
#define MAX_DMIC_SIZE 8
#define MAX_TMIC_SIZE 8
...
#ifdef BBR2_HW
#define PHY_INIT(glowLED) CC2520_Init(CC2520_RADIO_1, glowLED)
#endif
...
#ifdef BBR2_HW
// Radio RSSI offset is 76dbm and LNA Gain is 3 dbm
#define GET_LAST_RSSI() ( (int8)g_ucLastRSSI - 76 - 3 )
#endif
...
#ifdef BBR2_HW
#define PHY_IsBusyChannel() CC2520_IsBusyChannel()
#endif
