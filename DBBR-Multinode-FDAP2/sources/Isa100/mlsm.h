...
extern int16 g_nClockDriftTMR;

#define DRIFT_NOT_CONFIGURED  0
#define DRIFT_APPLY_ASAP      1
#define DRIFT_APPLIED         2

extern uint8 g_ucClockDriftStatus;
...
void MLSM_SetAbsoluteTAI( uint32 p_ulSec, uint32 p_ulSecFract2 );
