...
typedef enum{
  ...
  DPO_PKI_CERTIFICATE_TYPE            = 22,  
  DPO_DAQ_PUB_COMM_ENDPOINT           = 23,
  DPO_DAQ_PUB_OBJ_ATTR                = 24,
  DPO_DEVICE_ROLE                     = 25,
  DPO_UAP_CO_VERSION                  = 26,
  ...
  DPO_FW_UPLOAD_COMPLETED             = 27,
  DPO_FW_UPGRADE_CUTOVER_TIME         = 28,
  DPO_SW_REVISION_INFO                = 29,  

  DPO_CUSTOM_ALGORITHMS               = 30,
  DPO_BANNED_TIMEOUT                  = 31,
  DPO_ALARM_BANDWIDTH                 = 32,
  DPO_ALARM_RESET_TIMEOUT             = 33,   
