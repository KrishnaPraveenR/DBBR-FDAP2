...
#define GetAppMICType()           GetSecurityLevel() & 0x3 

unsigned char GetSecurityLevel();
unsigned char GetTLSecurityLevel();
unsigned char GetDLSecurityLevel();
unsigned char SetTLSecurityLevel(unsigned char);
unsigned char SetDLSecurityLevel(unsigned char);

uint8 GetMicSize(unsigned char);
