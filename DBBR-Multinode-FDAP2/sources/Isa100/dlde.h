...
extern DLL_HASH_STRUCT * g_pCrtHashEntry;
  ...
  extern DLL_HASH_STRUCT * g_pCandidateHashEntry;
#else  
  #define g_pCandidateHashEntry NULL
#endif  
...
extern DLL_DPDU * g_pDiscardMsg;
  ...
  extern uint8 g_aucDebug[72];
  extern uint8 g_ucDebugLastACKType;;
  
  #define SET_DebugLastAck(x) g_ucDebugLastACKType=(x)
#else
